    ...
    <article class="list-item" id="resto-item-${r.rank}" style="view-transition-name: resto-card-${r.rank}-${r.name.toLowerCase().replace(/[^a-z0-9]/g, '-')}">
      ...
      <div class="item-info">
        ...
        <div class="item-attributes">
          ...
          <div class="attr-item">${r.city}</div>
        </div>
        ...
        <p class="item-description">
          ${r.description.length > 350 ? `
            ...
            <button class="read-more-btn" onclick="toggleReadMore(${r.rank}, this)">Mostrar mais</button>
          ` : `
      ...
      <div class="item-media">
        <img loading="lazy" src="${r.imageUrl || 'Restaurantes 2026/1.jpg'}" alt="Foto de ${r.name}">
      </div>
